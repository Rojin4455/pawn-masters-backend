...
from .views import (
    ...
    SMSConfigurationViewSet, webhook_handler,
    WalletSyncView,CallSyncView,CompanyAccountView,TransactionAnalyticsViewSet,
    AccountDataForCompanyView,trigger_refresh_calls_task,trigger_refresh_conversations_task,make_api_call_view
)
from rest_framework.routers import DefaultRouter
router = DefaultRouter()
router.register(r'analytics', TransactionAnalyticsViewSet, basename='sms-analytics')
